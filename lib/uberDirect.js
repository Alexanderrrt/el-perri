...
export const isUberDirectConfigured = Boolean(clientId && clientSecret);
...
export async function createDelivery({
  ...
  try {
    ...
    const body = {
      ...
      dropoff_instructions: `Order for ${customerName}`,
    };

    const res = await fetch(`${API_BASE}/v1/deliveries`, {
      method: "POST",
      headers: {
