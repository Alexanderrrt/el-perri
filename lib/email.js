    ...
    const result = await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p style="margin:24px 0 4px"><a href="https://elperico.vercel.app/menu" style="background:#fcd116;color:#1a1a1a;padding:12px 22px;text-decoration:none;border-radius:8px;font-weight:700;display:inline-block">Ver el menú completo</a></p>
